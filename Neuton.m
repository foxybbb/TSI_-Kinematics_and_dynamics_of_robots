...
t6p=t6+t6+dT;
   ...
   n 
    if(abs(f(1))<1.0e-9 && abs(f(2))<1.0e-9 &&abs(f(3))<1.0e-9 && abs(f(4))<1.0e-9 && abs(f(5))<1.0e-9 && abs(f(6))<1.0e-9 && abs(f(7))<1.0e-9 && abs(f(8))<1.0e-9 && abs(f(10))<1.0e-9 && abs(f(11))<1.0e-9 && abs(f(12))<1.0e-9)
