function [thetas]=Newton(dM,iniguess)
t1=iniguess(1);
t2=iniguess(2);
t3=iniguess(3);
t4=iniguess(4);
...
for n=1:1000
    ...
    J(8,1)=(f8(t1p,t2,t3,t4,t5,t6,dM)-f8(t1,t2,t3,t4,t5,t6,dM))/dT;
    ...
    J(9,1)=(f9(t1p,t2,t3,t4,t5,t6,dM)-f9(t1,t2,t3,t4,t5,t6,dM))/dT;
    J(9,2)=(f9(t1,t2p,t3,t4,t5,t6,dM)-f9(t1,t2,t3,t4,t5,t6,dM))/dT;
    J(9,3)=(f9(t1,t2,t3p,t4,t5,t6,dM)-f9(t1,t2,t3,t4,t5,t6,dM))/dT;
    J(9,4)=(f9(t1,t2,t3,t4p,t5,t6,dM)-f9(t1,t2,t3,t4,t5,t6,dM))/dT;
    J(9,5)=(f9(t1,t2,t3,t4,t5p,t6,dM)-f9(t1,t2,t3,t4,t5,t6,dM))/dT;
    J(9,6)=(f9(t1,t2,t3,t4,t5,t6p,dM)-f9(t1,t2,t3,t4,t5,t6,dM))/dT;
    ...
    if (abs (f(1))<1.0e-9 && (f(2))<1.0e-9 && (f(3))<1.0e-9 && (f(4))<1.0e-9 && (f(5))<1.0e-9 && (f(6))<1.0e-9 && (f(7))<1.0e-9 && (f(8))<1.0e-9 && (f(9))<1.0e-9 && (f(10))<1.0e-9 && (f(11))<1.0e-9 && (f(12))<1.0e-9),break;end
end
